...
def printHelp() {
  log.info"""
  Usage:
    nextflow run BCCDC-PHL/rsv-a-artic-nf -profile conda --prefix [prefix] [workflow-options]

  Description:
    Turn Illumina respiratory syncytial virus A (RSV-A) sequencing reads generated by ARTIC tiling amplification protocols into consensus sequences.
